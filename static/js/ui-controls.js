...
if (closeSidebarBtn) {
  closeSidebarBtn.addEventListener('click', () => {
    ...
    // Reuse direct toggleSidebar approach or custom logic
    if (typeof toggleSidebar === 'function') {
      toggleSidebar('sidebar', false);
    } else {
      // Fallback if toggleSidebar not available
...
const themeToggleAgain = document.getElementById('theme-toggle');
if (themeToggleAgain) {
  themeToggleAgain.addEventListener('click', () => {
