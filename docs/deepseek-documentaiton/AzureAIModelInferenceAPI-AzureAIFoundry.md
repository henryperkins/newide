...
4. [Content safety](#content-safety)
...
Models deployed to [serverless API endpoints](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-serverless):

- [Cohere Embed V3](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-cohere-embed) family of models
- [Cohere Command R](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-cohere-command) family of models
- [Meta Llama 2 chat](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-llama) family of models
- [Meta Llama 3 instruct](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-llama) family of models
- [Mistral-Small](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-mistral)
- [Mistral-Large](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-mistral)
- [Jais](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-jais-models) family of models
- [Jamba](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-jamba) family of models
- [Phi-3](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-phi-3) and [Phi-4](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-phi-4) family of models
- [DeepSeek-R1](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-deepseek) family of models.

Models deployed to [managed inference](https://learn.microsoft.com/en-us/azure/ai-studio/concepts/deployments-overview):

- [Meta Llama 3 instruct](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-llama) family of models
- [Phi-3](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-phi-3), and [Phi-4](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-phi-4) family of models
- [Mistral](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-mistral-open) and [Mixtral](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-mistral-open?tabs=mistral-8x7B-instruct) family of models

Models deployed to [Azure AI model inference in Azure AI Services](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/overview):

- See [supported models](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/concepts/models).
...
The following section describes some of the capabilities the API exposes. For a full specification of the API, view the [reference section](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/reference/reference-model-inference-info).
...
- [Get info](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/reference/reference-model-inference-info): Returns the information about the model deployed under the endpoint.
- [Text embeddings](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/reference/reference-model-inference-embeddings): Creates an embedding vector representing the input text.
- [Chat completions](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/reference/reference-model-inference-chat-completions): Creates a model response for the given chat conversation.
- [Image embeddings](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/reference/reference-model-inference-images-embeddings): Creates an embedding vector representing the input text and image.
...
When working with the Azure AI model inference endpoint (preview), the base URL to connect to is of the form `https://<resource-name>.services.ai.azure.com/models`. Use this URL with the parameter `endpoint`. If using REST APIs, such is the base URL you have to append to the modality you want to consume. Read about [how to use the Azure AI model inference endpoint](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/how-to/inference).
...
Use the reference section to explore the API design and which parameters are available. For example, the reference section for [Chat completions](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/reference/reference-model-inference-chat-completions) details how to use the route `/chat/completions` to generate predictions based on chat-formatted instructions:
...
The Azure AI model inference API supports [Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-studio/concepts/content-filtering). When using deployments with Azure AI Content Safety on, inputs and outputs pass through an ensemble of classification models aimed at detecting and preventing the output of harmful content. The content filtering (preview) system detects and takes action on specific categories of potentially harmful content in both input prompts and output completions.
...
The Azure AI Model Inference API is currently supported in certain models deployed as [Serverless API endpoints](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-serverless) and Managed Online Endpoints. Deploy any of the [supported models](#availability) and use the exact same code to consume their predictions.
...
- [Configure your AI project to use Azure AI model inference - Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/how-to/quickstart-ai-project?source=recommendations)
    
    Learn how to upgrade your AI project to use models deployed in Azure AI model inference in Azure AI Foundry
